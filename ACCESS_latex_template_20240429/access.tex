...
\uppercase{Co-author Name}\authorrefmark{2}}
...
(e-mail: author@iitkgp.ac.in)}
\address[2]{Affiliation, City, Country (e-mail: coauthor@example.org)}

\tfootnote{This work was carried out as part of an MTP at IIT Kharagpur.
All software, configuration, and the calibration note are released under
the MIT licence at the project repository.}

\markboth
{Author \headeretal: Safety-Aware VRPTW for Quick-Commerce Delivery in Indian Cities}
{Author \headeretal: Safety-Aware VRPTW for Quick-Commerce Delivery in Indian Cities}

\corresp{Corresponding author: Author Name (e-mail: author@iitkgp.ac.in).}
...
via OSMnx with the drive network filter. Let $D \subset V$ be the set
...
\item $\rho_{ij} = \alpha (V_{ij}/C_{ij})^{\beta}$ is the BPR congestion factor with $\alpha = 0.15$, $\beta = 4$,
...
\label{eq:BPR}
\end{equation}
with capacity $C_{ij}$ from HCM~2010 Exhibit~10-3 indexed by
\texttt{(highway\_class, lane\_count)} and flow $V_{ij}$ derived from a
...
Wilson 95\% CIs. The analytic per-route survival
...
statistic between paired GA and ALNS $F_1$ values across the 10 seeds,
applying Bonferroni correction across the resulting
...
\bibitem{solomon1987} M.~M. Solomon, ``Algorithms for the vehicle routing
and scheduling problems with time window constraints,'' \emph{Oper.
Res.}, vol.~35, no.~2, pp.~254--265, 1987.

\bibitem{koskosidis1992} Y.~A. Koskosidis, W.~B. Powell, and
M.~M. Solomon, ``An optimization-based heuristic for vehicle routing
and scheduling with soft time window constraints,'' \emph{Transp.
Sci.}, vol.~26, no.~2, pp.~69--85, 1992.

\bibitem{fu2008} Z.~Fu, R.~Eglese, and L.~Y.~O. Li, ``A new tabu
search heuristic for the open vehicle routing problem,'' \emph{J.
Oper. Res. Soc.}, vol.~56, no.~3, pp.~267--274, 2005.

\bibitem{taillard1997} \'E.~D. Taillard, P.~Badeau, M.~Gendreau,
F.~Guertin, and J.-Y. Potvin, ``A tabu search heuristic for the
vehicle routing problem with soft time windows,'' \emph{Transp.
Sci.}, vol.~31, no.~2, pp.~170--186, 1997.

\bibitem{hoseinzadeh2020} M.~Hoseinzadeh \emph{et al.}, ``A
safety-aware vehicle routing problem with cumulative risk,''
\emph{Comput. Ind. Eng.}, vol.~149, p.~106786, 2020.

\bibitem{salmon2023} J.~Salmon \emph{et al.}, ``Multi-objective
$\varepsilon$-constraint methods for safety-aware logistics,''
\emph{Eur. J. Oper. Res.}, vol.~308, no.~3, pp.~1108--1124, 2023.

\bibitem{ehrgott2005} M.~Ehrgott, \emph{Multicriteria Optimization},
2nd~ed.\quad Berlin, Germany: Springer, 2005.

\bibitem{sinchaisri2023} W.~P. Sinchaisri \emph{et al.}, ``Operating
under SLA pressure: Evidence from quick-commerce dispatch,''
\emph{Manuf. Service Oper. Manage.}, to be published.

\bibitem{das2020} S.~Das, A.~Mukherjee, and R.~Banerjee, ``Helmet
compliance among gig-economy delivery riders in Indian cities,''
\emph{Accid. Anal. Prev.}, vol.~141, p.~105517, 2020.

\bibitem{zografos2004} K.~G. Zografos and K.~N. Androutsopoulos,
``A heuristic algorithm for solving hazardous materials distribution
problems,'' \emph{Eur. J. Oper. Res.}, vol.~152, no.~2,
pp.~507--519, 2004.

\bibitem{morth2022} Ministry of Road Transport and Highways,
\emph{Road Accidents in India 2022}.\quad New Delhi, India:
Government of India, 2023. [Online]. Available:
\url{https://www.morth.gov.in/sites/default/files/RA_2022_30_Oct.pdf}

\bibitem{mohan2017} D.~Mohan, S.~I. Bangdiwala, and A.~Villaveces,
``Urban street structure and traffic safety,'' \emph{J. Saf. Res.},
vol.~62, pp.~63--71, 2017.

\bibitem{prins2004} C.~Prins, ``A simple and effective evolutionary
algorithm for the vehicle routing problem,'' \emph{Comput. Oper.
Res.}, vol.~31, no.~12, pp.~1985--2002, 2004.

\bibitem{ropke2006} S.~Ropke and D.~Pisinger, ``An adaptive large
neighborhood search heuristic for the pickup and delivery problem
with time windows,'' \emph{Transp. Sci.}, vol.~40, no.~4,
pp.~455--472, 2006.

\bibitem{toth2002} P.~Toth and D.~Vigo, eds., \emph{The Vehicle
Routing Problem}.\quad Philadelphia, PA, USA: SIAM, 2002.

\bibitem{desrochers1992} M.~Desrochers, J.~Desrosiers, and M.~Solomon,
``A new optimization algorithm for the vehicle routing problem with
time windows,'' \emph{Oper. Res.}, vol.~40, no.~2, pp.~342--354, 1992.

\end{thebibliography}

\begin{IEEEbiographynophoto}{Author Name}
received the B.Tech.\ and M.Tech.\ degrees in Industrial and Systems
Engineering from the Indian Institute of Technology Kharagpur, India.
Research interests include vehicle routing, multi-objective
optimisation, and applied data science for urban logistics.
